...
return [
    ...
    */
    'sections' => [
        'content' => [
            ...
            'categories' => [
                ...
                'gallery', 'testimonial', 'slider', 'reference', 'faq', 'why-choose-us',
                'menu', 'media',
            ],
        ],
        'marketing' => [
    ...
    'permissions' => [
        ...
        ['name' => 'page.seo', 'label' => 'Sayfa - SEO', 'category' => 'page', 'guard_name' => 'web'],
        ...
        ['name' => 'announcement.index', 'label' => 'Duyuru Şeridi - Listele', 'category' => 'announcement', 'guard_name' => 'web'],
        ['name' => 'announcement.datatable', 'label' => 'Duyuru Şeridi - Tablo', 'category' => 'announcement', 'guard_name' => 'web'],
        ['name' => 'announcement.form', 'label' => 'Duyuru Şeridi - Form', 'category' => 'announcement', 'guard_name' => 'web'],
        ['name' => 'announcement.store', 'label' => 'Duyuru Şeridi - Ekle', 'category' => 'announcement', 'guard_name' => 'web'],
        ['name' => 'announcement.update', 'label' => 'Duyuru Şeridi - Düzenle', 'category' => 'announcement', 'guard_name' => 'web'],
        ['name' => 'announcement.destroy', 'label' => 'Duyuru Şeridi - Sil', 'category' => 'announcement', 'guard_name' => 'web'],

        ['name' => 'popup.index', 'label' => 'Açılır Pencere - Listele', 'category' => 'popup', 'guard_name' => 'web'],
        ['name' => 'popup.datatable', 'label' => 'Açılır Pencere - Tablo', 'category' => 'popup', 'guard_name' => 'web'],
        ['name' => 'popup.form', 'label' => 'Açılır Pencere - Form', 'category' => 'popup', 'guard_name' => 'web'],
        ['name' => 'popup.store', 'label' => 'Açılır Pencere - Ekle', 'category' => 'popup', 'guard_name' => 'web'],
        ['name' => 'popup.update', 'label' => 'Açılır Pencere - Düzenle', 'category' => 'popup', 'guard_name' => 'web'],
        ['name' => 'popup.destroy', 'label' => 'Açılır Pencere - Sil', 'category' => 'popup', 'guard_name' => 'web'],

        ['name' => 'subscriber.index', 'label' => 'Bülten - Listele', 'category' => 'subscriber', 'guard_name' => 'web'],
        ['name' => 'subscriber.datatable', 'label' => 'Bülten - Tablo', 'category' => 'subscriber', 'guard_name' => 'web'],
        ['name' => 'subscriber.export', 'label' => 'Bülten - Dışa Aktar', 'category' => 'subscriber', 'guard_name' => 'web'],
        ['name' => 'subscriber.destroy', 'label' => 'Bülten - Sil', 'category' => 'subscriber', 'guard_name' => 'web'],
        ...
        ['name' => 'blog.seo', 'label' => 'Blog - SEO', 'category' => 'blog', 'guard_name' => 'web'],
        ['name' => 'blog.schema-org', 'label' => 'Blog - Schema.org', 'category' => 'blog', 'guard_name' => 'web'],
        ...
        ['name' => 'slider.index', 'label' => 'Slayt - Listele', 'category' => 'slider', 'guard_name' => 'web'],
        ['name' => 'slider.datatable', 'label' => 'Slayt - Tablo', 'category' => 'slider', 'guard_name' => 'web'],
        ['name' => 'slider.form', 'label' => 'Slayt - Form', 'category' => 'slider', 'guard_name' => 'web'],
        ['name' => 'slider.store', 'label' => 'Slayt - Kaydet', 'category' => 'slider', 'guard_name' => 'web'],
        ['name' => 'slider.reorder', 'label' => 'Slayt - Sırala', 'category' => 'slider', 'guard_name' => 'web'],
        ['name' => 'slider.update', 'label' => 'Slayt - Güncelle', 'category' => 'slider', 'guard_name' => 'web'],
        ['name' => 'slider.destroy', 'label' => 'Slayt - Sil', 'category' => 'slider', 'guard_name' => 'web'],
        ['name' => 'slider.bulk', 'label' => 'Slayt - Toplu İşlem', 'category' => 'slider', 'guard_name' => 'web'],
        ...
        ['name' => 'service.seo', 'label' => 'Hizmet - SEO', 'category' => 'service', 'guard_name' => 'web'],
        ['name' => 'service.schema-org', 'label' => 'Hizmet - Schema.org', 'category' => 'service', 'guard_name' => 'web'],
        ...
        ['name' => 'project.seo', 'label' => 'Neler Yaptık - SEO', 'category' => 'project', 'guard_name' => 'web'],
        ['name' => 'project.schema-org', 'label' => 'Neler Yaptık - Schema.org', 'category' => 'project', 'guard_name' => 'web'],
