    ...
    <div class="md:flex md:items-center md:justify-between">
        <div class="flex items-center justify-center md:justify-normal">
            ...
            <div
                ...
                <button type="button" class="transition-all relative top-[2px] hover:text-primary-500"
                    id="dropdownToggleBtn">
                    <i class="material-symbols-outlined !text-[22px] md:!text-xl">
                        apps
                    </i>
                </button>
                <div
                    ...
                    <ul class="grid grid-cols-3 text-center gap-[5px]">
                        <li>
                            <a href="https://www.figma.com/"
                                ...
                                target="_blank">
                                <img src="{{ asset('admin/assets/images/icons/figma.svg') }}" class="inline-block" alt="figma">
                        ...
                        <li>
                            <a href="https://dribbble.com/"
                                class="block text-xs mb-[15px] text-black transition-all hover:text-primary-500 dark:text-white"
                                target="_blank">
                                <img src="{{ asset('admin/assets/images/icons/dribbble.svg') }}" class="inline-block" alt="dribbble">
                                <span class="block mt-[7px]">
                                    Dribbble
                                </span>
                            </a>
                        ...
                        <li>
                            <a href="https://open.spotify.com/"
                                class="block text-xs mb-[15px] text-black transition-all hover:text-primary-500 dark:text-white"
                                target="_blank">
                                <img src="{{ asset('admin/assets/images/icons/spotify.svg') }}" class="inline-block" alt="spotify">
                                <span class="block mt-[7px]">
                                    Spotify
                                </span>
                            </a>
                        ...
                        <li>
                            <a href="https://gitlab.com/"
                                class="block text-xs mb-[15px] text-black transition-all hover:text-primary-500 dark:text-white"
                                target="_blank">
                                <img src="{{ asset('admin/assets/images/icons/gitlab.svg') }}" class="inline-block" alt="gitlab">
                                <span class="block mt-[7px]">
                                    Gitlab
                                </span>
                            </a>
                        ...
                        <li>
                            <a href="https://drive.google.com/"
                                class="block text-xs mb-[15px] text-black transition-all hover:text-primary-500 dark:text-white"
                                target="_blank">
                                <img src="{{ asset('admin/assets/images/icons/google-drive.svg') }}" class="inline-block" alt="google-drive">
                                <span class="block mt-[7px]">
                                    GDrive
                                </span>
                            </a>
                        ...
                        <li>
                            <a href="https://trello.com/"
                                class="block text-xs mb-[15px] text-black transition-all hover:text-primary-500 dark:text-white"
                                target="_blank">
                                <img src="{{ asset('admin/assets/images/icons/trello.svg') }}" class="inline-block" alt="trello">
                                <span class="block mt-[7px]">
                                    Trello
                                </span>
                            </a>
                        ...
                        <li>
                            <a href="https://slack.com/"
                                class="block text-xs mb-[15px] text-black transition-all hover:text-primary-500 dark:text-white"
                                target="_blank">
                                <img src="{{ asset('admin/assets/images/icons/slack.svg') }}" class="inline-block" alt="slack">
                                <span class="block mt-[7px]">
                                    Slack
                                </span>
                            </a>
                        ...
                        <li>
                            <a href="https://www.pinterest.com/"
                                class="block text-xs mb-[15px] text-black transition-all hover:text-primary-500 dark:text-white"
                                target="_blank">
                                <img src="{{ asset('admin/assets/images/icons/pinterest.svg') }}" class="inline-block" alt="pinterest">
                                <span class="block mt-[7px]">
                                    Pinterest
                                </span>
                            </a>
                        ...
                        <li>
                            <a href="https://www.facebook.com/"
                                class="block text-xs mb-[15px] text-black transition-all hover:text-primary-500 dark:text-white"
                                target="_blank">
                                <img src="{{ asset('admin/assets/images/icons/facebook.svg') }}" class="inline-block" alt="facebook">
                                <span class="block mt-[7px]">
                                    Facebook
                                </span>
                            </a>
                        ...
                        <li>
                            <a href="https://www.linkedin.com/"
                                class="block text-xs mb-[15px] text-black transition-all hover:text-primary-500 dark:text-white"
                                target="_blank">
                                <img src="{{ asset('admin/assets/images/icons/linkedin.svg') }}" class="inline-block" alt="linkedIn">
                                <span class="block mt-[7px]">
                                    LinkedIn
                                </span>
                            </a>
        ...
        <ul class="flex items-center justify-center md:justify-normal mt-[13px] md:mt-0">
            ...
            <li
                ...
                <button type="button"
                    ...
                    <i
                        class="ri-arrow-down-s-line text-[15px] absolute -right-[3px] top-1/2 -translate-y-1/2 -mt-[2px]"></i>
                </button>
                <div
                    class="language-menu-dropdown bg-white dark:bg-[#0c1427] transition-all shadow-3xl dark:shadow-none pt-[13px] md:pt-[14px] absolute mt-[18px] md:mt-[21px] w-[200px] md:w-[240px] z-[1] top-full ltr:left-0 ltr:md:left-auto ltr:lg:right-0 rtl:right-0 rtl:md:right-auto rtl:lg:left-0 rounded-md">
                    <span
                    ...
                    <ul>
                        <li class="border-t border-dashed border-gray-100 dark:border-[#172036]">
                            <button type="button"
                                class="text-black dark:text-white px-[20px] py-[12px] w-full font-medium">
                                <div class="flex items-center">
                                    <img src="{{ asset('admin/assets/images/flags/usa.svg') }}"
                                        class="w-[30px] ltr:mr-[10px] rtl:ml-[10px]" alt="usa">
                                    English
                                </div>
                            </button>
                        </li>
                        <li class="border-t border-dashed border-gray-100 dark:border-[#172036]">
                            <button type="button"
                                class="text-black dark:text-white px-[20px] py-[12px] w-full font-medium">
                                <div class="flex items-center">
                                    <img src="{{ asset('admin/assets/images/flags/france.svg') }}"
                                        class="w-[30px] ltr:mr-[10px] rtl:ml-[10px]" alt="france">
                                    French
                                </div>
                            </button>
                        </li>
                        <li class="border-t border-dashed border-gray-100 dark:border-[#172036]">
                            <button type="button"
                                class="text-black dark:text-white px-[20px] py-[12px] w-full font-medium">
                                <div class="flex items-center">
                                    <img src="{{ asset('admin/assets/images/flags/germany.svg') }}"
                                        class="w-[30px] ltr:mr-[10px] rtl:ml-[10px]" alt="germany">
                                    German
                                </div>
                            </button>
                        </li>
                        <li class="border-t border-dashed border-gray-100 dark:border-[#172036]">
                            <button type="button"
                                class="text-black dark:text-white px-[20px] py-[12px] w-full font-medium">
                                <div class="flex items-center">
                                    <img src="{{ asset('admin/assets/images/flags/portugal.svg') }}"
                                        class="w-[30px] ltr:mr-[10px] rtl:ml-[10px]" alt="portugal">
                                    Portuguese
                                </div>
                            </button>
                        </li>
                        <li class="border-t border-dashed border-gray-100 dark:border-[#172036]">
                            <button type="button"
                                class="text-black dark:text-white px-[20px] py-[12px] w-full font-medium">
                                <div class="flex items-center">
                                    <img src="{{ asset('admin/assets/images/flags/spain.svg') }}"
                                        class="w-[30px] ltr:mr-[10px] rtl:ml-[10px]" alt="spain">
                                    Spanish
                                </div>
                            </button>
                        </li>
            ...
            <li
                ...
                <button type="button"
                    ...
                    id="fullscreenBtn">
                    <i class="material-symbols-outlined !text-[22px] md:!text-xl" id="fullscreenIcon">
                        fullscreen
                    </i>
                </button>
            </li>
            <li
                ...
                <button type="button"
                    ...
                    <span
                        class="top-[3px] ltr:right-[4px] rtl:left-[4px] w-[6px] h-[6px] rounded-full absolute bg-orange-500"></span>
                </button>
                <div
                    ...
                    <ul class="mb-[18px]">
                        <li
                            ...
                            <a href="notifications.html"
                                class="block left-0 top-0 right-0 bottom-0 z-[1] absolute"></a>
                        </li>
                        <li
                            class="relative border-b border-gray-100 dark:border-[#172036] border-dashed py-[17px] ltr:pl-[75px] ltr:pr-[20px] rtl:pr-[75px] rtl:pl-[20px] first:border-t first:border-gray-100 dark:first:border-[#172036]">
                            <div
                            ...
                            <a href="notifications.html"
                                class="block left-0 top-0 right-0 bottom-0 z-[1] absolute"></a>
                            <span
                                class="inline-block rounded-full bg-primary-500 absolute w-[6px] h-[6px] right-[20px] top-1/2 -translate-y-1/2"></span>
                        </li>
                        <li
                            class="relative border-b border-gray-100 dark:border-[#172036] border-dashed py-[17px] ltr:pl-[75px] ltr:pr-[20px] rtl:pr-[75px] rtl:pl-[20px] first:border-t first:border-gray-100 dark:first:border-[#172036]">
                            <div
            ...
            <li
                ...
                <button type="button"
                    ...
                    id="dropdownToggleBtn">
                    <img src="{{ asset('admin/assets/images/admin.png') }}"
                        ...
                        alt="admin-image">
                    <span class="block font-semibold text-[0px] lg:text-base">
                        Olivia
                    </span>
                    <i
