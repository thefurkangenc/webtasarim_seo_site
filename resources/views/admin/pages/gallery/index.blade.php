...
@section('admin.title', 'Foto Galeri')

@section('content')
    <div class="mb-[25px] md:flex items-center justify-between">
        <h5 class="!mb-0">Foto Galeri</h5>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-3 gap-[15px] md:gap-[25px] mb-[25px]">
        @php
            $cards = [
                ['Toplam Galeri', $stats['total'], 'photo_library', 'text-primary-500', 'bg-primary-50'],
    ...
    <div class="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
        <div class="trezo-card-header mb-[20px] md:mb-[25px]">
            <div class="sm:flex sm:items-start sm:justify-between gap-[15px]">
                ...
                <div class="trezo-card-subtitle mt-[15px] sm:mt-0 flex items-center gap-[10px] flex-wrap shrink-0">
                    ...
                    <x-admin::activity-log-button module="gallery" />
                    @can('gallery.create')
            ...
            <div class="flex items-center gap-[10px] flex-wrap mt-[15px] md:mt-[20px]">
                <div class="relative grow max-w-[240px]">
                    <input type="text" id="gallery-search" placeholder="Başlık veya açıklama ara..."
                ...
                <select id="gallery-status" data-choices
                    ...
                    @foreach (\App\Models\Gallery\Gallery::STATUSES as $value => $label)
        ...
        <div class="trezo-card-content">
            <x-admin::bulk-bar module="gallery" />
                ...
                <table class="w-full">
                    <thead class="text-black dark:text-white">
                        <tr>
                            ...
                            <th class="font-medium ltr:text-left rtl:text-right px-[20px] py-[11px] bg-gray-50 dark:bg-[#15203c] whitespace-nowrap w-[70px]">
                                Kapak
                            </th>
                            <th class="font-medium ltr:text-left rtl:text-right px-[20px] py-[11px] bg-gray-50 dark:bg-[#15203c] whitespace-nowrap cursor-pointer relative" data-column="title">
                                Galeri <i class="ri-expand-up-down-fill text-gray-500 dark:text-gray-400"></i>
                            </th>
                    ...
                    <tbody class="text-black dark:text-white" id="gallery-table-body"></tbody>
                </table>
            </div>
        </div>
    </div>
