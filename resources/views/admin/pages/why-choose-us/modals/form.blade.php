...
<form id="why-choose-us-form" data-id="{{ $whyChooseUs?->id }}">
    <x-admin::form.input name="title" label="Başlık" required :value="$whyChooseUs?->title" />

    <x-admin::form.textarea name="description" label="Açıklama" rows="5" required :value="$whyChooseUs?->description" />
