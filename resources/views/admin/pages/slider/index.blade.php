...
@section('content')
    ...
    <div class="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
        <div class="trezo-card-header mb-[20px] md:mb-[25px] sm:flex sm:items-center sm:justify-between">
            ...
            <div class="trezo-card-subtitle mt-[15px] sm:mt-0 flex items-center gap-[10px] flex-wrap">
                <div class="relative grow max-w-[240px]">
                    <input type="text" id="slider-search" placeholder="Ara..."
                    ...
                    @can('slider.reorder')
                    <button type="button" id="slider-reorder"
                ...
                @endcan
                    ...
                    <x-admin::activity-log-button module="slider" />
                    @can('slider.store')
                    <button type="button" id="slider-create"
        ...
        <div class="trezo-card-content">
            <x-admin::bulk-bar module="slider" />
            ...
            <div class="table-responsive overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="text-black dark:text-white" id="slider-table-body"></tbody>
                </table>
            </div>
        </div>
    </div>
...
@push('admin.scripts')
    <script type="module" src="{{ asset('assets/admin/js/pages/slider/index.js') }}"></script>
@endpush
