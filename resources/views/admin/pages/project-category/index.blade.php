...
@section('admin.title', 'Proje Kategorileri')
        ...
        <div class="trezo-card-header mb-[20px] md:mb-[25px] sm:flex sm:items-center sm:justify-between">
            <div class="trezo-card-title">
                ...
                <span class="text-xs text-gray-500 dark:text-gray-400">
                    Ön yüzdeki proje filtresi bu listeye göre çalışır. Projesi olan kategori silinemez.
                </span>
            </div>
            <div class="trezo-card-subtitle mt-[15px] sm:mt-0 flex items-center gap-[10px] flex-wrap">
                ...
                <x-admin::activity-log-button module="project-category" />
                @can('project-category.store')
...
@push('admin.scripts')
    <script type="module" src="{{ asset('admin/assets/js/pages/project-category/index.js') }}"></script>
@endpush
