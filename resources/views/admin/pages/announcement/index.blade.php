...
@section('admin.title', 'Duyuru Şeridi')

@section('content')
    <div class="mb-[25px] md:flex items-center justify-between">
        <h5 class="!mb-0">Duyuru Şeridi</h5>
        <ol class="breadcrumb mt-[12px] md:mt-0">
            ...
            <li class="breadcrumb-item inline-block relative text-sm mx-[11px]">Duyuru Şeridi</li>
        </ol>
    </div>
    ...
    <div class="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
        <div class="trezo-card-header mb-[20px] md:mb-[25px] sm:flex sm:items-center sm:justify-between">
            <div class="trezo-card-title">
                <h5 class="!mb-0">Şeritler</h5>
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-[4px] max-w-[560px]">
                    Header'ın üstünde görünen ince şerit. Aynı anda birden fazla kayıt yayındaysa
                    o sayfaya uyan en yenisi gösterilir. Ziyaretçi kapattığında bir daha çıkmaz.
                </p>
            </div>
            <div class="trezo-card-subtitle mt-[15px] sm:mt-0 flex items-center gap-[10px] flex-wrap">
                <div class="relative grow max-w-[240px]">
                    <input type="text" id="announcement-search" placeholder="Ara..."
                ...
                <x-admin::activity-log-button module="announcement" />
                @can('announcement.store')
                    <button type="button" id="announcement-create"
            ...
            <div class="table-responsive overflow-x-auto">
                <table class="w-full">
                    <thead class="text-black dark:text-white">
                        <tr>
                            <th class="font-medium ltr:text-left rtl:text-right px-[20px] py-[11px] bg-gray-50 dark:bg-[#15203c] whitespace-nowrap cursor-pointer relative first:rounded-tl-md" data-column="title">
                                Ad <i class="ri-expand-up-down-fill text-gray-500 dark:text-gray-400"></i>
                            </th>
                            <th class="font-medium ltr:text-left rtl:text-right px-[20px] py-[11px] bg-gray-50 dark:bg-[#15203c] whitespace-nowrap">Hedef</th>
                            <th class="font-medium ltr:text-left rtl:text-right px-[20px] py-[11px] bg-gray-50 dark:bg-[#15203c] whitespace-nowrap">Takvim</th>
                    ...
                    <tbody class="text-black dark:text-white" id="announcement-table-body"></tbody>
                </table>
            </div>
        </div>
    </div>
...
@push('admin.scripts')
    <script type="module" src="{{ asset('admin/assets/js/pages/announcement/index.js') }}"></script>
@endpush
