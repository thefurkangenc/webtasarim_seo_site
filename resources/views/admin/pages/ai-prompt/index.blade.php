...
@section('admin.title', 'Prompt Şablonları')

@section('content')
    <div class="mb-[25px] md:flex items-center justify-between">
        <h5 class="!mb-0">Prompt Şablonları</h5>
        ...
        <div class="trezo-card-header mb-[20px] md:mb-[25px] sm:flex sm:items-center sm:justify-between">
            <div class="trezo-card-title">
                ...
                <p class="!mb-0 mt-[5px] text-sm text-gray-500 dark:text-gray-400">
                    Anahtar, şablonun hangi modülde görüneceğini belirler — blog formu <code class="text-xs">blog.content</code> şablonlarını listeler.
                </p>
            </div>
            <div class="trezo-card-subtitle mt-[15px] sm:mt-0 flex items-center gap-[10px] flex-wrap">
                <div class="relative grow max-w-[240px]">
                    <input type="text" id="prompt-search" placeholder="Ara..."
                ...
                @can('ai-prompt.create')
                    <button type="button" id="prompt-create"
                ...
                <table class="w-full">
                    <thead class="text-black dark:text-white">
                        <tr>
                            ...
                            <th class="font-medium ltr:text-left rtl:text-right px-[20px] py-[11px] bg-gray-50 dark:bg-[#15203c] whitespace-nowrap cursor-pointer relative" data-column="key">
                                Anahtar <i class="ri-expand-up-down-fill text-gray-500 dark:text-gray-400"></i>
                            </th>
                    ...
                    <tbody class="text-black dark:text-white" id="prompt-table-body"></tbody>
                </table>
            </div>
        </div>
    </div>
...
@push('admin.scripts')
    <script type="module" src="{{ asset('admin/assets/js/pages/ai-prompt/index.js') }}"></script>
@endpush
