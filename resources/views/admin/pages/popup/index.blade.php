...
@section('admin.title', 'Açılır Pencereler')

@section('content')
    <div class="mb-[25px] md:flex items-center justify-between">
        <h5 class="!mb-0">Açılır Pencereler</h5>
        <ol class="breadcrumb mt-[12px] md:mt-0">
            ...
            <li class="breadcrumb-item inline-block relative text-sm mx-[11px]">Açılır Pencereler</li>
        </ol>
    </div>
    ...
    <div class="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
        <div class="trezo-card-header mb-[20px] md:mb-[25px] sm:flex sm:items-center sm:justify-between">
            <div class="trezo-card-title">
                <h5 class="!mb-0">Pencereler</h5>
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-[4px] max-w-[560px]">
                    Sayfanın ortasında açılan duyuru. Bülten formu eklenebilir. Ziyaretçi kapattığında
                    aynı kayıt bir daha gösterilmez.
                </p>
            </div>
            <div class="trezo-card-subtitle mt-[15px] sm:mt-0 flex items-center gap-[10px] flex-wrap">
                <div class="relative grow max-w-[240px]">
                    <input type="text" id="popup-search" placeholder="Ara..."
                ...
                <x-admin::activity-log-button module="popup" />
                @can('popup.store')
                    <button type="button" id="popup-create"
        ...
        <div class="trezo-card-content">
            <div class="table-responsive overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="text-black dark:text-white" id="popup-table-body"></tbody>
                </table>
            </div>
        </div>
    </div>
...
@push('admin.scripts')
    <script type="module" src="{{ asset('admin/assets/js/pages/popup/index.js') }}"></script>
@endpush
