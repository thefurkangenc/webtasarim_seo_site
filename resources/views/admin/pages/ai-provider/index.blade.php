...
@section('admin.title', 'Yapay Zeka Sağlayıcıları')

@section('content')
    <div class="mb-[25px] md:flex items-center justify-between">
        <h5 class="!mb-0">Yapay Zeka Sağlayıcıları</h5>
    ...
    <div class="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
        <div class="trezo-card-header mb-[20px] md:mb-[25px] sm:flex sm:items-center sm:justify-between">
            <div class="trezo-card-title">
                <h5 class="!mb-0">Sağlayıcılar</h5>
                <p class="!mb-0 mt-[5px] text-sm text-gray-500 dark:text-gray-400">
                    İçerik üretiminde kullanılacak servisler. Varsayılan sağlayıcı, şablonda seçim yapılmadığında kullanılır.
                </p>
            </div>
            <div class="trezo-card-subtitle mt-[15px] sm:mt-0 flex items-center gap-[10px] flex-wrap">
                <div class="relative grow max-w-[240px]">
                    <input type="text" id="provider-search" placeholder="Ara..."
                ...
                <select id="provider-driver" data-choices
            ...
            <div class="table-responsive overflow-x-auto">
                <table class="w-full">
                    <thead class="text-black dark:text-white">
                        <tr>
                            <th class="font-medium ltr:text-left rtl:text-right px-[20px] py-[11px] bg-gray-50 dark:bg-[#15203c] whitespace-nowrap first:rounded-tl-md last:rounded-tr-md cursor-pointer relative" data-column="name">
                                Ad <i class="ri-expand-up-down-fill text-gray-500 dark:text-gray-400"></i>
                            </th>
                            <th class="font-medium ltr:text-left rtl:text-right px-[20px] py-[11px] bg-gray-50 dark:bg-[#15203c] whitespace-nowrap cursor-pointer relative" data-column="driver">
                                Servis <i class="ri-expand-up-down-fill text-gray-500 dark:text-gray-400"></i>
                            </th>
                            <th class="font-medium ltr:text-left rtl:text-right px-[20px] py-[11px] bg-gray-50 dark:bg-[#15203c] whitespace-nowrap cursor-pointer relative" data-column="model">
                                Model <i class="ri-expand-up-down-fill text-gray-500 dark:text-gray-400"></i>
                            </th>
                    ...
                    <tbody class="text-black dark:text-white" id="provider-table-body"></tbody>
                </table>
            </div>
        </div>
    </div>
...
@push('admin.scripts')
    <script type="module" src="{{ asset('admin/assets/js/pages/ai-provider/index.js') }}"></script>
@endpush
