...
<form id="setting-form" action="{{ route('admin.setting.tracking.update') }}" method="POST">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-[20px] md:gap-[25px]">
        <div class="settings-panel">
            <div class="flex items-center gap-[12px] mb-[20px]">
                <span class="settings-chip w-[40px] h-[40px] flex items-center justify-center shrink-0">
                    <img src="{{ asset('assets/admin/images/icons/tracking/google.svg') }}" alt="Gaziantep Web Tasarım Ajansı Google Icon" class="w-[24px] h-[24px] object-contain">
                </span>
        ...
        <div class="settings-panel">
            <div class="flex items-center gap-[12px] mb-[20px]">
                <span class="settings-chip w-[40px] h-[40px] flex items-center justify-center shrink-0">
                    <img src="{{ asset('assets/admin/images/icons/tracking/microsoft.svg') }}" alt="Gaziantep Web Tasarım Ajansı Microsoft Icon" class="w-[24px] h-[24px] object-contain">
                </span>
        ...
        <div class="settings-panel">
            <div class="flex items-center gap-[12px] mb-[20px]">
                <span class="settings-chip w-[40px] h-[40px] flex items-center justify-center shrink-0">
                    <img src="{{ asset('assets/admin/images/icons/tracking/meta.svg') }}" alt="Gaziantep Web Tasarım Ajansı Meta Icon" class="w-[24px] h-[24px] object-contain">
                </span>
        ...
        <div class="settings-panel">
            <div class="flex items-center gap-[12px] mb-[20px]">
                <span class="settings-chip w-[40px] h-[40px] flex items-center justify-center shrink-0">
                    <img src="{{ asset('assets/admin/images/icons/tracking/yandex.svg') }}" alt="Gaziantep Web Tasarım Ajansı Yandex Icon" class="w-[24px] h-[24px] object-contain">
                </span>
        ...
        <div class="settings-panel">
            <div class="flex items-center gap-[12px] mb-[20px]">
                <span class="settings-chip w-[40px] h-[40px] flex items-center justify-center shrink-0">
                    <img src="{{ asset('assets/admin/images/icons/tracking/tiktok.svg') }}" alt="Gaziantep Web Tasarım Ajansı TikTok Icon" class="w-[24px] h-[24px] object-contain">
                </span>
        ...
        <div class="settings-panel">
            <div class="flex items-center gap-[12px] mb-[20px]">
                <span class="settings-chip w-[40px] h-[40px] flex items-center justify-center shrink-0">
                    <img src="{{ asset('assets/admin/images/icons/tracking/linkedin.svg') }}" alt="Gaziantep Web Tasarım Ajansı LinkedIn Icon" class="w-[24px] h-[24px] object-contain">
                </span>
