...
<div class="{{ $wrapper }}">
    ...
    <div data-media-field
        ...
        class="relative border border-gray-200 dark:border-[#172036] rounded-md p-[15px]">
        ...
        <div class="flex items-center gap-[15px]">
            ...
            <div data-media-preview
                class="{{ $media ? '' : 'hidden' }} shrink-0 w-[110px] h-[80px] rounded-md overflow-hidden border border-gray-100 dark:border-[#172036] bg-gray-50 dark:bg-[#15203c]">
            ...
            <div data-media-empty
                class="{{ $media ? 'hidden' : '' }} shrink-0 w-[110px] h-[80px] rounded-md border border-dashed border-gray-200 dark:border-[#172036] flex items-center justify-center text-gray-400">
                <i class="material-symbols-outlined !text-[28px]">image</i>
            </div>

            <div class="grow min-w-0">
                <p data-media-info class="!mb-[8px] text-xs text-gray-500 dark:text-gray-400 truncate">
                    @if ($media)
