                    ...
                    @foreach ($homeServices as $homeService)
                        ...
                        <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="900">
                            <div class="service14-boxarea">
                                <div class="icons">
                                    <img src="{{ asset("assets/img/icons/service14-icon{$homeServiceIcon}.svg") }}"
                                        alt="">
                                </div>
                                <div class="space28"></div>
                                <div class="content14-area">
                                    <a href="{{ route('hizmetler.show', $homeService->slug) }}"
                                        class="title">{{ $homeServiceGeneric['title'] }}</a>
                                    <div class="space16"></div>
                                    <p>{{ $homeServiceGeneric['excerpt'] ?: \Illuminate\Support\Str::limit(strip_tags((string) $homeServiceGeneric['content']), 120) }}
                                    </p>
                                    <div class="space24"></div>
                                    <div class="btn-area1">
                                        <a href="{{ route('hizmetler.show', $homeService->slug) }}"
                                            class="theme-btn27">Detaylı Bilgi</a>
                                    </div>
                                </div>
                            </div>
                        </div>
