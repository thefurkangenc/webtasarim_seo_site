...
/**
 * Hizmet bölgesi ağacının kökü: Türkiye'nin 81 ili. id = plaka kodu.
 * İlçe ve mahalleler panelden elle eklenir.
 *
 * Tekrar çalıştırılabilir — mevcut il kaydının adı/slug'ı tazelenir, elle
 * değiştirilmiş sıralama ve durum korunur, alt bölgelere dokunulmaz.
 */
class ServiceRegionSeeder extends Seeder
{
    /** Plaka kodu => il adı. */
    ...
    public function run(): void
    {
        ...
        $this->command?->info(count(self::CITIES).' il hizmet bölgesi olarak hazır.');
    }
}
