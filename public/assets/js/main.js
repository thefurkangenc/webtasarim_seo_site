...
//-- testimonial 9 ---
$(".testimonial11-slider-area").slick({
  slidesToShow: 1,
  slidesToScroll: 1,
  arrows: true,
  dots: false,
  ...
  infinite: true,
  vertical: false,
  prevArrow: $('.tes11-prev-arrow'),
  nextArrow: $('.tes11-next-arrow'),
});


//-- testimonial 9 ---
$(".testimonial25-slider-area").slick({
  slidesToShow: 1,
  slidesToScroll: 1,
  arrows: true,
  dots: false,
  ...
  infinite: true,
  vertical: false,
  prevArrow: $('.tes25-prev-arrow'),
  nextArrow: $('.tes25-next-arrow'),
});

//-- testimonial 9 ---
$(".testimonial24-slider-area").slick({
  slidesToShow: 1,
  slidesToScroll: 1,
  arrows: true,
  dots: false,
  ...
  infinite: true,
  vertical: false,
  prevArrow: $('.tes24-prev-arrow'),
  nextArrow: $('.tes24-next-arrow'),
});
//-- testimonial 12 Hero ---
$(".hero12-images-slider").slick({
  slidesToShow: 2,
  slidesToScroll: 1,
  arrows: false,
  dots: false,
...
fadeSpeed: 1000,
dots: false,
prevArrow: $('.prev-arrow-s11'),
nextArrow: $('.next-arrow-s11'),
responsive: [
  {
    breakpoint: 769,
    settings: {
...
$(".hero13-brand-slider-area").slick({
      autoplay: true,
      autoplaySpeed: 0,
      speed: 5000,
      arrows: false,
...
$(".tes13-slider").slick({
  ...
  focusOnSelect: true,
  infinite: true,
  prevArrow: $('.tes13-prev-arrow'),
  nextArrow: $('.tes13-next-arrow'),
  vertical: true,
});

//-- testimonial 13 ---
$(".team13-slider-area").slick({
  slidesToShow: 3,
  slidesToScroll: 1,
  arrows: true,
  dots: false,
  ...
  focusOnSelect: true,
  infinite: true,
  prevArrow: $('.prev13-arrow'),
  nextArrow: $('.next13-arrow'),
  responsive: [
      {
        breakpoint: 769,
        settings: {
...
//-- testimonial 13 ---
$(".testimonial14-slider-area").slick({
  slidesToShow: 3,
  slidesToScroll: 1,
  arrows: true,
  dots: false,
  ...
  focusOnSelect: true,
  infinite: true,
  prevArrow: $('.prev14-arrow'),
  nextArrow: $('.next14-arrow'),
  responsive: [
      {
        breakpoint: 769,
        settings: {
...
$(".case15-slider-area").slick({
  ...
  focusOnSelect: true,
  infinite: true,
  prevArrow: $('.prev15-case-arrow'),
  nextArrow: $('.next15-case-arrow'),
  responsive: [
      {
        breakpoint: 769,
        settings: {
...
$(".tes16-slider").slick({
  ...
  loop: true,
  focusOnSelect: true,
    prevArrow: $('.prev16-arrow'),
  nextArrow: $('.next16-arrow'),
  infinite: true,
  responsive: [
      {
        breakpoint: 769,
...
$(".service17-slider-area").slick({
  ...
  loop: true,
  focusOnSelect: true,
    prevArrow: $('.service17-prev-area'),
  nextArrow: $('.service17-next-area'),
  infinite: true,
  responsive: [
      {
        breakpoint: 769,
...
$(".team24-slider-area").slick({
  ...
  loop: true,
  focusOnSelect: true,
    prevArrow: $('.team24-prev-arrow'),
  nextArrow: $('.team24-next-arrow'),
  infinite: true,
  responsive: [
      {
        breakpoint: 769,
...
$('.case18-slider-area').owlCarousel({
  loop:true,
  margin:30,
  nav:true,
  dots:false,
...
// testimonial //
$('.project19-slider-area').owlCarousel({
  loop:true,
  margin:30,
  nav:false,
  dots:true,
...
$('.testimonial19-boxarea-vertical').slick({
  slidesToScroll: 1,
  arrows: true,
  dots: true,
  vertical: true,
  ...
  // testimonial //
$('.case20-slider-area').owlCarousel({
  loop:true,
  margin:30,
  nav:true,
  dots:true,
  ...
  // testimonial //
$('.case22-slider-area').owlCarousel({
  loop:true,
  margin:30,
  nav:true,
  dots:true,
  ...
  // testimonial //
$('.case23-slider-area').owlCarousel({
  loop:true,
  margin:30,
  nav:false,
  dots:true,
...
// testimonial //
$('.testimonial20-slider-area').owlCarousel({
  loop:true,
  margin:30,
  nav:false,
  dots:true,
...
// testimonial //
$('.testimonial21-slider').owlCarousel({
  loop:true,
  margin:30,
  nav:true,
  dots:false,
...
// testimonial //
$('.testimonial23-slider').owlCarousel({
  loop:true,
  margin:30,
  nav:true,
  dots:false,
...
// SWIPER SLIDER //
document.addEventListener("DOMContentLoaded", function () {
  var swiper3 = new Swiper(".swiper-thumb22", {
    spaceBetween: 10,
    slidesPerView: 6,
    freeMode: true,
    watchSlidesProgress: true,
  ...
  var swiper4 = new Swiper(".swiper-testimonial-22", {
    spaceBetween: 10,
    loop: true,
    navigation: {
